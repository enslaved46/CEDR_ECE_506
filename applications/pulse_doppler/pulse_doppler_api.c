...
void xcorr(double *x, double *y, size_t n_samp, double *corr) {
  ...
  //from RADAR example
  dash_cmplx_flt_type *X1 = (dash_cmplx_flt_type*) malloc(len * sizeof(dash_cmplx_flt_type));
  dash_cmplx_flt_type *X2 = (dash_cmplx_flt_type*) malloc(len * sizeof(dash_cmplx_flt_type));
  dash_cmplx_flt_type *corr_freq = (dash_cmplx_flt_type*) malloc(len * sizeof(dash_cmplx_flt_type));
